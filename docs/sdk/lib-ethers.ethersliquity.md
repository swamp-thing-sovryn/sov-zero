...
|  [borrowZSUSD(amount, maxBorrowingRate, overrides)](./lib-ethers.ethersliquity.borrowzsusd.md) |  | Adjust existing Trove by borrowing more ZSUSD. |
...
|  [depositZSUSDInStabilityPool(amount, frontendTag, overrides)](./lib-ethers.ethersliquity.depositzsusdinstabilitypool.md) |  | Make a new Stability Deposit, or top up existing one. |
...
|  [getNUEBalance(address, overrides)](./lib-ethers.ethersliquity.getnuebalance.md) |  | Get the amount of ZSUSD held by an address. |
...
|  [getZSUSDBalance(address, overrides)](./lib-ethers.ethersliquity.getzsusdbalance.md) |  | Get the amount of ZSUSD held by an address. |
|  [getZSUSDInStabilityPool(overrides)](./lib-ethers.ethersliquity.getzsusdinstabilitypool.md) |  | Get the total amount of ZSUSD currently deposited in the Stability Pool. |
...
|  [openTrove(params, maxBorrowingRate, overrides)](./lib-ethers.ethersliquity.opentrove.md) |  | Open a new Trove by depositing collateral and borrowing ZSUSD. |
|  [redeemZSUSD(amount, maxRedemptionRate, overrides)](./lib-ethers.ethersliquity.redeemzsusd.md) |  | Redeem ZSUSD to native currency (e.g. Ether) at face value. |
...
|  [repayZSUSD(amount, overrides)](./lib-ethers.ethersliquity.repayzsusd.md) |  | Adjust existing Trove by repaying some of its debt. |
|  [sendZERO(toAddress, amount, overrides)](./lib-ethers.ethersliquity.sendzero.md) |  | Send ZERO tokens to an address. |
|  [sendZSUSD(toAddress, amount, overrides)](./lib-ethers.ethersliquity.sendzsusd.md) |  | Send ZSUSD tokens to an address. |
...
|  [withdrawGainsFromStaking(overrides)](./lib-ethers.ethersliquity.withdrawgainsfromstaking.md) |  | Withdraw [collateral gain](./lib-base.zerostake.collateralgain.md) and [ZSUSD gain](./lib-base.zerostake.zsusdgain.md) from ZERO stake. |
|  [withdrawZSUSDFromStabilityPool(amount, overrides)](./lib-ethers.ethersliquity.withdrawzsusdfromstabilitypool.md) |  | Withdraw ZSUSD from Stability Deposit. |
