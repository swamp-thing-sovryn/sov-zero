...
|  maxBorrowingRate | [Decimalish](./lib-base.decimalish.md) | Maximum acceptable [borrowing rate](./lib-base.fees.borrowingrate.md) if <code>params</code> includes <code>borrowZSUSD</code>. |
...
The transaction will fail if the Trove's debt would fall below [ZSUSD\_MINIMUM\_DEBT](./lib-base.zsusd_minimum_debt.md)<!-- -->.
