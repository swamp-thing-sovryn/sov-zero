...
|  [borrowZSUSD(amount, maxBorrowingRate)](./lib-base.sendableliquity.borrowzsusd.md) | Adjust existing Trove by borrowing more ZSUSD. |
...
|  [depositZSUSDInStabilityPool(amount, frontendTag)](./lib-base.sendableliquity.depositzsusdinstabilitypool.md) | Make a new Stability Deposit, or top up existing one. |
...
|  [openTrove(params, maxBorrowingRate)](./lib-base.sendableliquity.opentrove.md) | Open a new Trove by depositing collateral and borrowing ZSUSD. |
|  [redeemZSUSD(amount, maxRedemptionRate)](./lib-base.sendableliquity.redeemzsusd.md) | Redeem ZSUSD to native currency (e.g. Ether) at face value. |
...
|  [repayZSUSD(amount)](./lib-base.sendableliquity.repayzsusd.md) | Adjust existing Trove by repaying some of its debt. |
|  [sendZERO(toAddress, amount)](./lib-base.sendableliquity.sendzero.md) | Send ZERO tokens to an address. |
|  [sendZSUSD(toAddress, amount)](./lib-base.sendableliquity.sendzsusd.md) | Send ZSUSD tokens to an address. |
...
|  [withdrawGainsFromStaking()](./lib-base.sendableliquity.withdrawgainsfromstaking.md) | Withdraw [collateral gain](./lib-base.zerostake.collateralgain.md) and [ZSUSD gain](./lib-base.zerostake.zsusdgain.md) from ZERO stake. |
|  [withdrawZSUSDFromStabilityPool(amount)](./lib-base.sendableliquity.withdrawzsusdfromstabilitypool.md) | Withdraw ZSUSD from Stability Deposit. |
