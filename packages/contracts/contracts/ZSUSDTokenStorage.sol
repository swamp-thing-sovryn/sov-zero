...
contract ZSUSDTokenStorage is Initializable {
    uint256 internal _totalSupply;
    string internal constant _NAME = "ZSUSD Stablecoin";
    string internal constant _SYMBOL = "ZSUSD";
