...
contract('Gas cost tests', async accounts => {
  ...
  it("", async () => {
    ...
    // 10 accts each open Trove with 10 ether, withdraw 900 ZSUSD
    ...
    //1 accts open Trove with 1 ether and withdraw 100 ZSUSD
    ...
    // Account 500 opens with 1 ether and withdraws 100 ZSUSD
    ...
    // Check initial troves with starting 10E/90ZSUSD are still open
    for (account of accounts.slice(101, 111)) { assert.isTrue(await sortedTroves.contains(account)) }
  ...
  it("", async () => {
    ...
    //2 accts open Trove with 1 ether and withdraw 100 ZSUSD
  ...
  it("", async () => {
    ...
    //3 accts open Trove with 1 ether and withdraw 100 ZSUSD
  ...
  it("", async () => {
    ...
    //5 accts open Trove with 1 ether and withdraw 100 ZSUSD
  ...
  it("", async () => {
    ...
    //10 accts open Trove with 1 ether and withdraw 100 ZSUSD
  ...
  it("", async () => {
    ...
    // 10 accts each open Trove with 10 ether, withdraw 90 ZSUSD
    await th.openTrove_allAccounts(accounts.slice(101, 111), contracts, dec(10, 'ether'), dec(900, 18))
    for (account of accounts.slice(101, 111)) { assert.isTrue(await sortedTroves.contains(account)) }

    //20 accts open Trove with 1 ether and withdraw 100 ZSUSD
  ...
  it("", async () => {
    ...
    //30 accts open Trove with 1 ether and withdraw 100 ZSUSD
  ...
  it("", async () => {
    ...
    //40 accts open Trove with 1 ether and withdraw 100 ZSUSD
  ...
  it("", async () => {
    ...
    //45 accts open Trove with 1 ether and withdraw 100 ZSUSD
  ...
  it("", async () => {
    ...
    // Whale opens trove and fills SP with 1 billion ZSUSD
    ...
    // Check SP has 9e28 ZSUSD
    const ZSUSDinSP = (await stabilityPool.getTotalZSUSDDeposits()).toString()
    assert.equal(ZSUSDinSP, dec(9, 28))

    //1 acct opens Trove with 1 ether and withdraw 100 ZSUSD
    const _1_Defaulter = accounts.slice(1, 2)
    await th.openTrove_allAccounts(_1_Defaulter, contracts, dec(1, 'ether'), dec(60, 18))
    ...
    // Check initial troves with starting 10E/90ZSUSD, and whale's trove, are still open
    for (account of accounts.slice(101, 111)) { assert.isTrue(await sortedTroves.contains(account)) }
    assert.isTrue(await sortedTroves.contains(whale))

    //Check ZSUSD in SP has decreased but is still > 0
    const ZSUSDinSP_After = await stabilityPool.getTotalZSUSDDeposits()
    assert.isTrue(ZSUSDinSP_After.lt(web3.utils.toBN(dec(9, 28))))
    assert.isTrue(ZSUSDinSP_After.gt(web3.utils.toBN('0')))
  ...
  it("", async () => {
    ...
    //2 acct opens Trove with 1 ether and withdraw 100 ZSUSD
    const _2_Defaulters = accounts.slice(1, 3)
    await th.openTrove_allAccounts(_2_Defaulters, contracts, dec(1, 'ether'), dec(60, 18))
  ...
  it("", async () => {
    ...
    // Account 500 opens with 1 ether and withdraws 110 ZSUSD
  ...
  it("", async () => {
    ...
    // Account 500 opens with 1 ether and withdraws 180 ZSUSD
