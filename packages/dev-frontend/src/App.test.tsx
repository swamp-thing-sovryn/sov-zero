...
import { Decimal, ZSUSD_MINIMUM_NET_DEBT, Trove } from "@liquity/lib-base";

import App from "./App";

const params = { depositCollateral: Decimal.from(20), borrowZSUSD: ZSUSD_MINIMUM_NET_DEBT };
...
test("there's no smoke", async () => {
  ...
  expect(await findByText(/you can borrow zsusd by opening a trove/i)).toBeInTheDocument();
